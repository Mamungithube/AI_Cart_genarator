...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-production-ready-super-secret-key-change-in-prod-xyz987!'
)
...
if os.environ.get('POSTGRES_DB'):
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('POSTGRES_DB', 'card_db'),
            'USER': os.environ.get('POSTGRES_USER', 'card_user'),
            'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'card_secure_password_123'),
